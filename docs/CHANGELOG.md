## v0.4.19 [2026-09-12] 前回メンバーの確認・修正を簡単に
...
> スコアブック by CuViuをv0.4.19に更新しました。
>
> 選手名の候補表示をなくし、チーム名を入れると前回メンバーを確認してから登録できるようにしました。投手・背番号・守備位置も、その場で修正できます。
>
...
## v0.4.18 [2026-09-10] 守備変更・選手交代を一括記録できる統合画面を追加
...
> スコアブック by CuViuをv0.4.18に更新しました。
> 
> 守備変更・選手交代を1画面に統合。複数選手の守備入替、背番号、投手交代、DH消滅をまとめて記録し、最新変更は編集・取消できます。
> 
> https://cuviu.jp/apps/scorebook/
> #CuViu #野球スコアブック
...
> 実況入力で「ボール」などを音声入力した直後でも、1球が確実にカウントへ反映されるよう修正しました。
> 
> https://cuviu.jp/apps/scorebook/
> #CuViu #野球スコアブック
...
## v0.4.15 [2026-09-08] 実況入力時の画面をコンパクト化
...
> スコアブック by CuViuをv0.4.15に更新しました。
> 
> 実況入力中は通常入力ボタンと打球結果を折りたたみ、スコアプレビューを小さくしました。スマホの日本語キーボード使用時も入力欄を見やすくしています。
> 
> https://cuviu.jp/apps/scorebook/
> #CuViu #野球スコア
...
## v0.4.8 [2026-08-23] 忍者AdMaxの広告枠をiframe描画へ変更
